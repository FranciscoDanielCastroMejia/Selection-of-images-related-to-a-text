...
tokenizer = GPT2TokenizerFast.from_pretrained("nlpconnect/vit-gpt2-image-captioning", max_new_tokens=200)
# Image processor
...
if __name__=='__main__':
    ...
    #Para este punto ya se cuenta con una lista de todos los links los cuales estan 
    #contenidos en el arreglo "filepaths".
    ...
    imagen_path = 'https://tse1.mm.bing.net/th?id=OIP.YGBSlm6z37PnGr0zmsnupAHaFh&pid=Api&P=0&h=180'

    
            
    #se genera el caption del path de la imagen
    ...
    try:
        with open('hash_diccionario_gpt2.json', 'r') as archivo:
            diccionario = json.load(archivo)
        diccionario.update(hash_diccionario) #actualizamos los nuevos del programa

        with open('hash_paths_gpt2.json', 'r') as archivo:
    ...
    with open('hash_diccionario_gpt2.json', 'w') as file:
        json.dump(diccionario, file, indent=4)

    with open('hash_paths_gpt2.json', 'w') as file:
